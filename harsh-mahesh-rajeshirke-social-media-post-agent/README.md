...
User Input → AI Generation-API call → Interactive Results Display → Session History & Refinement

## Your tech-stack?
Backend: Python (Flask), Langchain, and Google Generative AI (Gemini model).
Frontend: HTML, CSS (Tailwind CSS), and JavaScript, Marked.js & Highlight.js.

## Github Profile
https://github.com/HarshRajeshirke
